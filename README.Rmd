...
<!-- badges: start -->
[![Travis build status](https://travis-ci.com/WeiquanLuo/rivertopo.svg?branch=master)](https://travis-ci.org/WeiquanLuo/rivertopo)
<!-- badges: end -->
...
<center>
![Workflow for rivertopo](inst/extdata/Workflow_ rivertopo.png){width=100%}
</center>

## Example

<center>
![Topology (green color) of Selected USGS Water Sampling Site along Topology (blue color) of River Topology within the Boundary of Hydrological Unit 07 and 10](inst/extdata/riverNet.png){width=100%}
</center>
